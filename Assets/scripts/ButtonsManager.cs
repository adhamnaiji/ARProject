...
public class ButtonsManager : MonoBehaviour
{
    ...
    public GameObject WatchesButtons;
    public GameObject PanelWatchWhite;
    public GameObject PanelWatchBlack;
    public GameObject PanelWatchBlue;
